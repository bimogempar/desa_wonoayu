        ...
        <div class="row">
            ...
            <div class="col-lg-7 col-md-6">
                <div class="about-content">
                    ...
                    <p>Wonoayu adalah sebuah desa di wilayah Kecamatan Wajak, Kabupaten Malang, Provinsi Jawa Timur.
                        Desa ini terletak sekitar 37 km dari kabupaten Malang. Desa ini memiliki luas wilayah 254,6 ha
                        dengan struktur tanah yang berbukit dan memiliki ketinggian tanah 630 Mdpl. Desa Wonoayu sudah
                        berdiri sejak tahun 1913 . Berawal dari perpindahan 11 kepala keluarga dari kecamatan
                        Poncokusumo, sampai akhirnya terbentuk menjadi sebuah desa baru.</p>
                    <p>Desa yang berkependudukan 1551 jiwa ini memiliki 6 RT dan mayoritas masyarakatnya beragama islam.
                        Sebagai wilayah yang terletak di bawah kaki Gunung Semeru, adapun suhu rata-rata yang ada yakni
                        berkisar antara 22°-27 °C. Daerah sejuk dan subur menjadikannya wilayah yang memiliki potensi
                        tinggi dalam hal sektor pertanian. Desa Wonoayu memiliki daerah yang cukup luas. Wilayah sebelah
                        timur berbatasan dengan Desa Sumberputih, wilayah sebelah utara berbatasan dengan Desa Bambang,
                        wilayah sebelah barat berbatasan dengan Desa Bringin dan wilayah sebelah selatan berbatasan
                        dengan Desa Sumber Putih. Desa Wonoayu dapat dikatakan sebagai desa yang tergolong maju, hal
                        tersebut terbukti dengan akses jalan menuju desa yang sudah beraspal dan tertata rapi. Juga
                        beberapa dari warga desanya telah mandiri dalam hal memanfaatkan peluang usaha di sektor
                        pertanian.</p>
                    <ul>
...
<section id="team">
    <div class="container">
        <div class="section-header">
            ...
            <p>Struktur Organisasi dan Tata Kerja Pemerintah Desa Wonoayu Kecamatan Wajak Kabupaten Malang Provinsi Jawa
                Timur</p>
        </div>
        ...
        <ul id="faq-list" class="wow fadeInUp">
            ...
            <li>
                ...
                <div id="faq2" class="collapse" data-parent="#faq-list">
                    <p>
                        Anda dapat melihat statistik kependudukan desa wonoayu pada halaman website ini.
                    </p>
                </div>
            </li>
            ...
            <li>
                <a data-toggle="collapse" href="#faq4" class="collapsed">Apakah saya bisa memberikan kritik dan saran
                    terhadap desa wonoayu melalui web ini?<i class="ion-android-remove"></i></a>
                <div id="faq4" class="collapse" data-parent="#faq-list">
                    <p>
                        Anda bisa memberikan kritik, saran dan masukan untuk desa wonoayu pada fitur curhat desa yang
                        telah disediakan di
                        website ini.
                    </p>
                </div>
