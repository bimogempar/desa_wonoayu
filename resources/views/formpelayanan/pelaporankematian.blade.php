...
@section('title','Form Pelaporan Kematian')

@section('content')
<div class="container" style="margin-top: 100px">
    <h1>FORMULIR PELAPORAN KEMATIAN</h1>
    <form>
        ...
        <div class="form-group">
            <label for="hub">Hubungan dengan yang mati</label>
            <input type="text" class="form-control" id="hub">
        </div>

        <h2>Melaporkan bahwa:</h2>
        <div class="form-row">
            <div class="form-group col-md-6">
                <label for="nama">Nama Lengkap</label>
                <input type="email" class="form-control" id="nama">
        ...
        <div class="form-row">
            <div class="form-group col-md-4">
                ...
                <input type="hari" class="form-control" id="hari">
            </div>
            <div class="form-group col-md-4">
        ...
        <div class="form-group">
            <label for="inputAddress">Bertempat di</label>
            <input type="text" class="form-control" id="inputAddress">
        </div>
        <div class="form-row">
            <div class="form-group col-md-6">
            ...
            <div class="form-group col-md-6">
                <label for="bukti">Bukti Kematian</label>
