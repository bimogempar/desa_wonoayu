...
<div class="container" style="margin-top: 100px">
    ...
    <div class="px-5">
        ...
        <div class="mt-5">
            <h2>Persyaratan Pengajuan e-KTP Baru</h2>
            <table class="table justify-content-center">
                ...
                <tbody>
                    ...
                    <th>
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Aperiam, sunt!
                            <br>
                            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Assumenda praesentium illo sed
                            odit
    ...
    <h2>Persyaratan Pengajuan Perubahan Data e-KTP</h2>
    <ul class="list-group">
    ...
    <h2>Persyaratan Pengajuan e-KTP Hilang</h2>
    <ul class="list-group">
    ...
    <h2>Persyaratan Pengajuan Kartu Keluarga</h2>
    ...
    <ul class="list-group">
        ...
        <li class="list-group-item">Melampirkan Surat Kehilangan dari Kepolisian</li>
        <li class="list-group-item">Lampiran Dokumen Pendukung Seperti : Akta Lahir, Surat Nikah, Ijazah, SK
            PNS/KARIP/SK TNI-POLRI, DLL</li>
    </ul>
    <h2>Persyaratan Pengajuan Kartu Keluarga</h2>
    ...
    <h2>Persyaratan Pengajuan Akta Kelahiran WNI</h2>
    <ul class="list-group">
    ...
    <h2>Persyaratan Pengurusan Akta Kematian (WNI)</h2>
    <ul class="list-group">
        ...
        <li class="list-group-item">Surat Keterangan Kematian Asli dari Rumah Sakit/Dokter/Surat Pernyataan Menininggal
            di Rumah</li>
    ...
    <ul class="list-group">
        ...
        <li class="list-group-item">Fotokopi Bukti Kepemilikan Tanah (Sertifikat/Akta Jual Beli/Petok D/Sewa Menyewa,
            DLL)</li>
    ...
    <ul class="list-group">
        <li class="list-group-item">Surat Rekomendasi dari Kepala UPTD Dinas Pendidikan Kabupaten Malang Kecamatam
            Setempat</li>
        <li class="list-group-item">Berita Acara Pemeriksaan yang Ditandatangani oleh Petugas/Pemilik UPTD TK/SD dan PLS
            Dinas Pendidikan Kabupaten Malang</li>
        ...
        <li class="list-group-item">Daftar Pengelola (Minimal 2 Orang) yang Bertugas Sebagai Ketua dan Petugas
            Administrasi Serta Teknis</li>
    ...
    <ul class="list-group">
        ...
        <li class="list-group-item">Melampirkan Surat Pernyataan Kesanggupan Menyetorkan Hasil Pungutan Retribusi Parkir
            ke Pemerintah Daerah sesuai dengan Potensi yang Ada</li>
        <li class="list-group-item">Melampirkan Surat Ijin Penyelenggaran Kegiatan atau Even Tertentu dari Pemerintah
            desa/Kelurahan</li>
    ...
    <ul class="list-group">
        ...
        <li class="list-group-item">Berita Acara Pemeriksaan yang Ditandatangani oleh Penilik/PLS dan Diketahui oleh
            Kepala UPTD Dinas Kependidikan Kabupaten Malang Kecamatan Setempat</li>
