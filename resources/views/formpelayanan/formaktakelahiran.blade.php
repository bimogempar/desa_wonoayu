...
<div class="container" style="margin-top: 100px">
    ...
    <form>
        ...
        <div class="form-row">
            <div class="form-group col-md-6">
                <label for="jenkel">Tempat Dilahirkan</label>
                <select id="jenkel" class="form-control">
                    <option selected>Tempat Dilahirkan</option>
                    <option>01. RS/RB</option>
                    <option>02. Puskesmas</option>
                    <option>03. Polindes</option>
                    <option>04. Rumah</option>
                    <option>05. Lainnya</option>
                </select>
            </div>
            <div class="form-group col-md-6">
        ...
        <div class="form-row">
            <div class="form-group col-md-4">
                <label for="jenis">Jenis Kelahiran</label>
                <select id="inputState" class="form-control">
                    <option selected>Jenis Kelahiran</option>
                    <option>01. Tunggal</option>
                    <option>02. Kembar 2</option>
                    <option>03. Kembar 3</option>
                    <option>04. Kembar 4</option>
                    <option>05. Lainnya</option>
                </select>
            </div>
            <div class="form-group col-md-4">
                <label for="ke">Kelahiran Ke</label>
                <select id="inputState" class="form-control">
            ...
            <div class="form-group col-md-4">
                ...
                <select id="penolong" class="form-control">
                    <option selected>Penolong Kelahiran</option>
                    <option>01. Dokter</option>
                    <option>02. Bidan/Perawat</option>
                    <option>03. Dukun</option>
                    <option>04. Lainnya</option>
                </select>
            </div>
        </div>
        <div class="form-row">
            ...
            <div class="form-group col-md-6">
                <label for="Panjang">Panjang Bayi</label>
        ...
        <div class="form-group">
            <label for="tglkawin">Tanggal Pencatatan Perkawinan</label>
        ...
        <div class="form-row">
            <div class="form-group col-md-4">
                <label for="NIK Saksi">NIK Saksi</label>
                <input type="email" class="form-control" id="NIK Saksi">
            </div>
            <div class="form-group col-md-8">
                <label for="NIK Saksi">Nama Lengkap Saksi</label>
                <input type="text" class="form-control" id="Nama Lengkap Saksi">
            </div>
        </div>
        <div class="form-row">
            <div class="form-group col-md-4">
